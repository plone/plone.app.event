...
class TestEventSummaryViewDX(AbstractSampleDataEvents):
    ...
    def test_event_summary_view__non_recurring(self):
        """Test if some specific content is included here.
        """
        headers, out, request = make_fake_response(self.request)
    ...
    @mock.patch('plone.app.event.base.localized_now', new=PN)
    def test_event_summary_view__recurring(self):
        """Test if some specific content is included here.
        """
        headers, out, request = make_fake_response(self.request)
    ...
    @mock.patch('plone.app.event.base.localized_now', new=PN)
    def test_event_summary_view__recurring_occurrence(self):
        """Test if some specific content is included here.
        """
        headers, out, request = make_fake_response(self.request)
    ...
    @mock.patch('plone.app.event.base.localized_now', new=PN)
    def test_event_summary_view__recurring_excludes(self):
        """Test if some specific content is included here.
        """
        headers, out, request = make_fake_response(self.request)
        view = self.portal.now.restrictedTraverse('@@event_summary')
...
class TestEventsListingAT(TestEventSummaryViewDX):
