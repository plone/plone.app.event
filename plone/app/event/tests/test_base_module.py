...
class TestGetEventsDX(AbstractSampleDataEvents):
    ...
    def test_get_events_ends(self):
        """#116 - incorrect occurrence end date for recurring event"""

        # add extra events to the base setup - or miss the bug
        factory = self.event_factory()
        factory(
            container=self.portal,
            content_id='past_recur',
        ...
        def fmt(seq):
            return [(x.title, x.end.strftime('%Y-%m-%d %H:%M:%S'))
                    for x in seq]

        #TestGetEventsATPydt
        occ_ATpydt = [(u'Past Event', '2013-04-25 23:59:59'),
                      (u'Long Event', '2013-06-04 10:00:00'),
                      (u'Past Recur', '2013-04-25 12:00:00'),
                      (u'Past Event', '2013-04-26 23:59:59'),
                      (u'Past Event', '2013-04-27 23:59:59'),
                      (u'Past Recur', '2013-05-02 12:00:00'),
                      (u'Now Event', '2013-05-05 11:00:00'),
                      # this one is ok
                      (u'Tomorrow event', '2013-05-06 11:00:00'),
                      (u'Now Event', '2013-05-07 11:00:00'),
                      (u'Now Event', '2013-05-09 11:00:00'),
                      (u'Past Recur', '2013-05-09 12:00:00'),
                      (u'Future Event', '2013-05-15 11:00:00'),
                      (u'Past Recur', '2013-05-16 12:00:00')]
        # TestGetEventsATZDT will be ignored, complete crap
        occ_ATZDT = [(u'Past Event', '2013-04-25 23:59:59'),
                     (u'Long Event', '2013-06-04 10:00:00'),
                     # incorrect now() endtime
                     (u'Past Recur', '2013-04-25 14:48:00'),
                     (u'Past Event', '2013-04-26 23:59:59'),
                     (u'Past Event', '2013-04-27 23:59:59'),
                     # incorrect now() endtime
                     (u'Past Recur', '2013-05-02 14:48:00'),
                     # ALL following are completely bogus
                     (u'Now Event', '2013-05-05 12:24:00'),
                     (u'Tomorrow event', '2013-05-06 12:24:00'),
                     (u'Now Event', '2013-05-07 12:24:00'),
                     (u'Now Event', '2013-05-09 12:24:00'),
                     (u'Past Recur', '2013-05-09 14:48:00'),
                     (u'Future Event', '2013-05-15 12:24:00'),
                     (u'Past Recur', '2013-05-16 14:48:00')]
        # TestGetEventsDX
        occ_DX = [(u'Past Event', '2013-04-25 23:59:59'),
                  (u'Long Event', '2013-06-04 10:00:00'),
                  (u'Past Recur', '2013-04-25 12:00:00'),
                  (u'Past Event', '2013-04-26 23:59:59'),
                  (u'Past Event', '2013-04-27 23:59:59'),
                  (u'Past Recur', '2013-05-02 12:00:00'),
                  (u'Now Event', '2013-05-05 11:00:00'),
                  # should be '2013-05-06 11:00:00'  <-- THIS IS THE BUG
                  (u'Tomorrow event', '2013-05-06 23:59:59'),
                  (u'Now Event', '2013-05-07 11:00:00'),
                  (u'Now Event', '2013-05-09 11:00:00'),
                  (u'Past Recur', '2013-05-09 12:00:00'),
                  (u'Future Event', '2013-05-15 11:00:00'),
                  (u'Past Recur', '2013-05-16 12:00:00')]
        # all occurrences ends, sorted by start
        res = fmt(get_events(self.portal, expand=True,
                             ret_mode=RET_MODE_ACCESSORS))

        # each of the 3 test layers exposes different results
        name = self.__class__.__name__
        if name == 'TestGetEventsATPydt':
            self.assertEqual(res, occ_ATpydt)
        elif name == 'TestGetEventsATZDT':
            # untestable since it returns now() based end times
            pass
            self.assertEqual(res, occ_ATZDT)
        elif name == 'TestGetEventsDX':
            # this is incorrect <-- THIS IS THE BUG #116
            self.assertEqual(res, occ_DX)
            # should be this one <-- THIS VERIFIES THE FIX
            #self.assertEqual(res, occ_ATpydt)
